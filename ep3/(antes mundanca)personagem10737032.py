"""
  ...
  -A funcao de busca foi baseada no exercicio complementar nº2 da
  seguinte lista:
...
def planejar(percepcao):
	...
	if 'I' in percepcao: #Caso a percepacao seja de impacto
		mundo[posicao[0]][posicao[1]] = "M" #marca aquela posicao como muro
		...
		if possibilidades == 1:
			if "F" in percepcao:
				mundo[posiOcorrencia[0]][posiOcorrencia[1]] = "W"
				contadorWumpus += 1
			if "B" in percepcao:
				mundo[posiOcorrencia[0]][posiOcorrencia[1]] = "P"

		mundo[posicao[0]][posicao[1]] = ["V"] #Marca a posicao atual como visitada
